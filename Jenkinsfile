...
// sample values commented below are for https://github.com/feedhenry-templates/pushstarter-cordova-app
/* ------------- use these to hardcode values in Jenkinsfile ---------------- */
PROJECT_NAME = "Push Starter"
CLEAN = true                          // Do a clean build and sign
INFO_PLIST = "${PROJECT_NAME}/${PROJECT_NAME}-Info.plist"
VERSION = "1.0.0"
SHORT_VERSION = "1.0"
BUNDLE_ID = "org.feedhenry.dart.aerogear.cordova"
